...
/** Read-only AP/LAT viewer with click-to-expand, shown for the loaded case. */
export function CaseImageBoard({ apFile, latFile }: CaseImageBoardProps) {
  ...
  if (views.length === 0) {
    return <p className="text-sm text-muted-foreground">No images loaded.</p>;
  }
        ...
        >
          ...
          >
            <div className="flex items-center justify-between gap-3 border-b border-white/10 px-4 py-3 sm:px-5">
              <h3 className="font-semibold text-white">{expanded.label} view</h3>
