...
function buildReportHtml(
  ...
  <main><header><h1>Paediatric Elbow Fracture Analysis Report</h1><p>Automated Gartland classification and supporting assessments</p><div class="meta"><strong>Generated:</strong> ${escapeHtml(generatedAt)}<br><strong>Minimum confidence level:</strong> ${(confidenceThreshold * 100).toFixed(0)}%<br><strong>Processing time:</strong> ${result.processing_time_seconds != null ? `${result.processing_time_seconds.toFixed(2)}s` : "n/a"}</div></header>
